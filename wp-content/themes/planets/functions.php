 ...
 */
function planets_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on planets, use a find and replace
		* to change 'planets' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'planets', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'planets' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'planets_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'planets_setup' );
...
function planets_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'planets_content_width', 640 );
}
add_action( 'after_setup_theme', 'planets_content_width', 0 );
...
function planets_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'planets' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'planets' ),
...
add_action( 'widgets_init', 'planets_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'planets_scripts' );
